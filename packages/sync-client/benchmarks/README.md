...
mutations and returning the acknowledgement.
...
threshold is asserted. `notesAppliedBeforeSlowUpload` measures whether completed
notes can be committed while the attachment is still uploading. Keep this
scenario unchanged when comparing push scheduling changes.
